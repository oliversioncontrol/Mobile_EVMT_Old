...
{
 public class InsertEquipmentService
    {
        /// <summary>
        /// Method for Insert New Equipment
        /// </summary>
        /// <param name="EquipModel"></param>
        /// <returns></returns>
        public async Task<string> InsertEquipment(InstEquipment EquipModel)
        {
            ...
            try
            {
                ...
                if (isconnected)
                {
                    ...
                    string serializedJsonRequest = JsonConvert.SerializeObject(EquipModel);
